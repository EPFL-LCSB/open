...
"taken from cobra v.0.17.1 and some minor modifications for the interface "
...
class HRSampler(object):
    ...
    def __init__(self, model, thinning, nproj=None, seed=None):
       ...
       # self.model = model.copy()
        ...
        self.feasibility_tol = model.configuration.tolerances.feasibility
        self.bounds_tol = model.configuration.tolerances.feasibility
